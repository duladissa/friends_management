...
func (o *PostFriendsUpdatesSubscribeURL) WithBasePath(bp string) *PostFriendsUpdatesSubscribeURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostFriendsUpdatesSubscribeURL) Build() (*url.URL, error) {
	var result url.URL

	var _path = "/friends/updates/subscribe"
...
func (o *PostFriendsUpdatesSubscribeURL) String() string {
...
func (o *PostFriendsUpdatesSubscribeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostFriendsUpdatesSubscribeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostFriendsUpdatesSubscribeURL")
	}
