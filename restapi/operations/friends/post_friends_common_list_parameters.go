...
// NewPostFriendsCommonListParams creates a new PostFriendsCommonListParams object
// no default values defined in spec.
func NewPostFriendsCommonListParams() PostFriendsCommonListParams {

	return PostFriendsCommonListParams{}
}

// PostFriendsCommonListParams contains all the bound params for the post friends common list operation
...
func (o *PostFriendsCommonListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PostFriendsCommonListParams) bindAcceptLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostFriendsCommonListParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
