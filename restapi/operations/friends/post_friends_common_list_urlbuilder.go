...
func (o *PostFriendsCommonListURL) WithBasePath(bp string) *PostFriendsCommonListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostFriendsCommonListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostFriendsCommonListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostFriendsCommonListURL")
	}
