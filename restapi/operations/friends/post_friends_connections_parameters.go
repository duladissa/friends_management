...
// NewPostFriendsConnectionsParams creates a new PostFriendsConnectionsParams object
// no default values defined in spec.
func NewPostFriendsConnectionsParams() PostFriendsConnectionsParams {

	return PostFriendsConnectionsParams{}
}

// PostFriendsConnectionsParams contains all the bound params for the post friends connections operation
...
func (o *PostFriendsConnectionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PostFriendsConnectionsParams) bindAcceptLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostFriendsConnectionsParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
