...
func (o *PostFriendsConnectionsListURL) WithBasePath(bp string) *PostFriendsConnectionsListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostFriendsConnectionsListURL) Build() (*url.URL, error) {
	...
	var _path = "/friends/connections/list"
...
func (o *PostFriendsConnectionsListURL) String() string {
...
func (o *PostFriendsConnectionsListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostFriendsConnectionsListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostFriendsConnectionsListURL")
	}
