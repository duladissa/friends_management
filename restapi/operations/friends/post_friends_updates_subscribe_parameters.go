...
// NewPostFriendsUpdatesSubscribeParams creates a new PostFriendsUpdatesSubscribeParams object
// no default values defined in spec.
func NewPostFriendsUpdatesSubscribeParams() PostFriendsUpdatesSubscribeParams {

	return PostFriendsUpdatesSubscribeParams{}
}

// PostFriendsUpdatesSubscribeParams contains all the bound params for the post friends updates subscribe operation
...
func (o *PostFriendsUpdatesSubscribeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PostFriendsUpdatesSubscribeParams) bindAcceptLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostFriendsUpdatesSubscribeParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
