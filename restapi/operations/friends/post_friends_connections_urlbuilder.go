...
func (o *PostFriendsConnectionsURL) WithBasePath(bp string) *PostFriendsConnectionsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostFriendsConnectionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostFriendsConnectionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostFriendsConnectionsURL")
	}
