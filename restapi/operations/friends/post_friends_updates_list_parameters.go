...
// NewPostFriendsUpdatesListParams creates a new PostFriendsUpdatesListParams object
// no default values defined in spec.
func NewPostFriendsUpdatesListParams() PostFriendsUpdatesListParams {

	return PostFriendsUpdatesListParams{}
}

// PostFriendsUpdatesListParams contains all the bound params for the post friends updates list operation
...
func (o *PostFriendsUpdatesListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ReceiveUpdatesFriends
...
func (o *PostFriendsUpdatesListParams) bindAcceptLanguage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostFriendsUpdatesListParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
