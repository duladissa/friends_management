...
func (o *PostFriendsUpdatesBlockURL) WithBasePath(bp string) *PostFriendsUpdatesBlockURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostFriendsUpdatesBlockURL) Build() (*url.URL, error) {
	...
	var _path = "/friends/updates/block"
...
func (o *PostFriendsUpdatesBlockURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostFriendsUpdatesBlockURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostFriendsUpdatesBlockURL")
	}
